...
export default function Details() {
  ...
  const [data, setData] = useState({}); // Estado para armazenar os dados do jogo
  const [plataformas, setPlataformas] = useState([]); // Estado para armazenar as plataformas de venda do jogo

  // Efeito para buscar os dados do jogo e as plataformas de venda ao montar o componente
  useEffect(() => {
    handleFetchData();
  }, []);

  // Função para buscar os dados do jogo e as plataformas de venda da API
  const handleFetchData = async () => {
    try {
      // Faz uma requisição GET para a rota 'games/:id' para obter os detalhes do jogo específico
      const response = await API.get(`games/${id}`);
      setData(response.data); // Atualiza o estado com os dados do jogo recebidos da API
          ...
          <div className='flex flex-wrap justify-around'>
            ...
            <div className='mt-10 md:mt-32 w-full md:w-[50%] lg:w-[40%]'>
              ...
              <div className='mt-6'>
                ...
                {/* Renderiza as plataformas de venda do jogo ou uma mensagem se não houver nenhuma */}
